...
import { Home, Login, Profile, Register, ResetPassword, Crypto, Loader, modelResetPassword } from "./pages"; //All pages currently
  ...
  return (
    <div data-theme={theme} className="w-full min-h-[100vh]">
      <Routes>
        ...
        <Route path="/modelResetPassword" element={<modelResetPassword/>} />
